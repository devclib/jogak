...
- **버전 동기화 (no functional change)**: `@jogak/core@1.1.0` (Themes + MDX docs + Parser skip reason) + `@jogak/ui@1.1.0` (툴바 theme/viewMode toggle + IframeMount pass-through) publish에 맞춰 caret semver 일관성 유지. `@jogak/cli` 소스 변경 없음.
...
- **버전 동기화 (no functional change)**: `@jogak/core@1.0.0-beta.7` publish에 맞춰 caret semver 일관성 유지. `@jogak/cli` 소스 변경 없음.
...
- **버전 동기화 (no functional change)**: `@jogak/core@1.0.0-beta.3` (A11y addon) + `@jogak/ui@1.0.0-beta.3` (A11yPanel) publish에 맞춰 caret semver 일관성 유지. `@jogak/cli` 소스 변경 없음.
...
- **버전 동기화 (no functional change)**: `@jogak/core@0.1.0-alpha.14.4` (Next.js Client 어댑터 nested root unmount race fix) publish에 맞춰 동기화. `@jogak/cli` 소스 변경 없음.

## [0.1.0-alpha.14.3] — 2026-05-15

### Changed

- **버전 동기화 (no functional change)**: `@jogak/core@0.1.0-alpha.14.3` 결함 fix(web-components iframe 어댑터 + codegen strict typecheck) publish에 맞춰 동기화. `@jogak/cli` 소스 변경 없음.

## [0.1.0-alpha.14.2] — 2026-05-11

### Changed

- **버전 동기화 (no functional change)**: `@jogak/ui@0.1.0-alpha.14.2` 패치 publish에 맞춰 동기화. `@jogak/cli` 소스 변경 없음.
