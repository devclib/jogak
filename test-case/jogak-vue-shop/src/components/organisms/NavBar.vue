...
<template>
  <header class="sticky top-0 z-10 bg-white border-b border-ink-100">
    <div class="max-w-6xl mx-auto h-14 px-4 flex items-center gap-6">
      <router-link to="/" class="font-bold text-ink-900 tracking-tight">{{ siteName }}</router-link>
      ...
      <router-link to="/cart" class="relative inline-flex items-center gap-2 text-sm text-ink-900 hover:text-brand-600">
        <span>🛒</span>
